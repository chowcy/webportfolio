	...
	<main id="main">
		...
		<section class="portfolio-section">
			<h3>Final Thoughts and Lessons</h3>
				...
				<p>The lesson learned here is that teams need to honestly assess each team member's strengths and weaknesses and ensure a project is doable, given everybody's capabilities. Our vision for this app was perhaps too ambitious, but we learned our lessons, and the next app we are developing -- and eye disease simulator -- is going great!</p>
		</section>
