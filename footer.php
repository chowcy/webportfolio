		<footer>
			<ul class="external-links">
				...
				<li><a href="https://github.com/chowcy" hreflang="en" target="_blank" aria-label="github"><i class="fa fa-github"></i><span id="github"></span></a></li>
			...
			<aside>&copy; Cathy Chow (<a href="mailto:chowcy@umich.edu" hreflang="en">chowcy@umich.edu</a>), last updated Mar 18, 2017</aside>
		</footer>