...
<?php $projects = true; include("header.php");?>
	<main id="main">
        ...
        <div data-uk-grid="{gutter: 10, controls: '#project-grid'}" class="uk-grid">
            <div class="uk-width-1-3" data-grid-prepared="true" data-uk-filter="filter-a"><div class="uk-panel-box"><section class="project">
            ...
            <div class="uk-width-1-3" data-grid-prepared="true" data-uk-filter="filter-b"><div class="uk-panel-box"><section class="project">
